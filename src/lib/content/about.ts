export const aboutFacts = [
  {
    icon: "🎓",
    label: "Education",
    value: "B.Tech in Polymer Science & Chemical Tech, DTU (2020)",
  },
  {
    icon: "🏢",
    label: "Current Role",
...
export const aboutEducation = {
  ...
  degree: "B.Tech in Polymer Science & Chemical Technology",
  years: "2016 — 2020",
  summary:
    "Graduated with a strong foundation in computational logic and analytical problem solving, then self-directed into fullstack and frontend engineering through data structures, algorithms, and production web builds.",
} as const;
