  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-3 z-40 flex justify-center px-3 sm:top-4 sm:px-6">
      <div className="pointer-events-auto w-full max-w-[1400px] px-0 sm:px-2 lg:px-4">
        <div className="flex items-center justify-between gap-2 rounded-full border border-border bg-background/70 px-3 py-2 shadow-[var(--ln-shadow-surface)] backdrop-blur-2xl backdrop-saturate-150 sm:gap-4 sm:px-4 sm:py-2.5">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-xs font-semibold uppercase tracking-[0.14em] text-foreground sm:tracking-[0.16em]">
                Shubham
              </span>
          ...
          <div className="hidden items-center gap-2.5 sm:flex">
            <nav className="flex items-center gap-1 rounded-full bg-muted/60 px-1 py-0.5 text-[11px] font-medium text-muted-foreground">
              {navItems.map((item) => {
                ...
                if (item.disabled) {
                  return (
                    <span
                      key={item.label}
                      title="Coming soon"
                      className="cursor-default rounded-full px-3 py-1 text-muted-foreground/50"
                    >
                      {item.label}
                    </span>
                  );
